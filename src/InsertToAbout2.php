...
?>
	...
	<form name="myForm" method="POST" enctype="multipart/form-data"
		...
		<span style="color: red" id="error-file"></span> 
		<input type="file"
...
function file_validate()
{
	...
	if(file.files.length != 0)
	{
		...
		{
			valid = false;
			document.getElementById('error-file').innerHTML = "* Filesize should be upto 3MB.";
		}
	}
	else
	{
		valid = false;
		document.getElementById('error-file').innerHTML = "* Please select any image file.";
	}
	if(valid==true)
	{
		// Image preview 
